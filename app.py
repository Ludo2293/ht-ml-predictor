...
def html_predict_league():
    def calcul_pred_league(id_league,num_saison):
        print(dir(chpp))
        print(dir(chpp.xml_league_fixtures(league_level_unit_id=id_league,season=num_saison).matches))
        ...
        #else:
        #    nb_matchs=56
        liste_matchs=[chpp.match(id_=o.ht_id) for o in chpp.xml_league_fixtures(league_level_unit_id=id_league,season=num_saison).matches]#[:nb_matchs]
